  ...
  return (
    <div>
      ...
      <div className="absolute top-[calc(35%)] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <h1 className="text-white text-4xl md:text-8xl mt-10 uppercase text-center">
          Үүрэг ресорт
        </h1>
      </div>
      <div className="z-10 absolute top-[calc(75%)] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <button className=" hover:!ring-[1px] text-center !px-12 !py-5 border  ring-gray-200 font-light">
          <Link
